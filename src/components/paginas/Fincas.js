 ...
 const formik = useFormik({
  ...
  onSubmit: finca => {
      try {   
          let config={
            method:'post',
            url:'https://murmuring-wave-68820.herokuapp.com/api/fincas',
            headers:{
...
<div className="flex justify-center mt-10">
    <div className="w-full max-w-3xl">
        ...
        >
            ...
            <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="legalidad">Lealidad</label>
                <input 
                    className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    id="legalidad"
                    type="text"
