...
const Platillo = ({platillo}) => {
    ...
    //modificar el esatdo del platillo en firebase 
                    ...
                    <div className="lg:w-5/12 xl:w-3/12">
                        ...
                        <div className="sm:flex sm:-mx-2 pl-2">
                            <label className="block mt-5 sm:w-2/4">
                                ...
                                <select 
                                className="bg-white shadow appearance-none border rounded w-full py-2 px-3 leading-tigth focus:outline-none focus:shadow-outline"
                                    value={existencia}
                                    ref={existenciaRef}
